...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v7/widget/ae;->c(Landroid/support/v7/widget/RecyclerView$w;)V
.end annotation
...
# direct methods
.method constructor <init>(Landroid/support/v7/widget/ae;Landroid/support/v7/widget/RecyclerView$w;Landroid/view/View;Landroid/view/ViewPropertyAnimator;)V
    .locals 0
...
.method public onAnimationCancel(Landroid/animation/Animator;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ae$5;->b:Landroid/view/View;
...
.method public onAnimationEnd(Landroid/animation/Animator;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ae$5;->c:Landroid/view/ViewPropertyAnimator;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/view/ViewPropertyAnimator;->setListener(Landroid/animation/Animator$AnimatorListener;)Landroid/view/ViewPropertyAnimator;

    iget-object v0, p0, Landroid/support/v7/widget/ae$5;->d:Landroid/support/v7/widget/ae;

    iget-object v1, p0, Landroid/support/v7/widget/ae$5;->a:Landroid/support/v7/widget/RecyclerView$w;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ae;->k(Landroid/support/v7/widget/RecyclerView$w;)V
...
.method public onAnimationStart(Landroid/animation/Animator;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ae;->n(Landroid/support/v7/widget/RecyclerView$w;)V
